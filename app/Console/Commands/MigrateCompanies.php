...
class migratecompanies extends Command
{
    ...
    { 
        ...
        foreach($dbs as $db){
            ...
            Artisan::call('migrate',array('--path'=>'database/migrations/companiesmigrations')); 
            
            $this->info( Artisan::output());
            
            $this->info("Companies Migration run successfully on ".$db);
        }
        
        Helper::resetDefaultConnection();
